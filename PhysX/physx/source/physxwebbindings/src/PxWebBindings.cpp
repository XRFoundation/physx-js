...
EMSCRIPTEN_BINDINGS(physx)
{
  ...
  class_<PxShape>("PxShape")
      ...
      .function("setLocalPose", &PxShape::setLocalPose, allow_raw_pointers())
      .function("getLocalPose", &PxShape::getLocalPose, allow_raw_pointers())
      .function("setGeometry", &PxShape::setGeometry)
      .function("getGeometry", &PxShape::getGeometry, allow_raw_pointers())
      ...
      .function("getConvexMeshGeometry", &PxShape::getConvexMeshGeometry, allow_raw_pointers())
      .function("getTriangleMeshGeometry", &PxShape::getTriangleMeshGeometry, allow_raw_pointers())
      .function("getHeightFieldGeometry", &PxShape::getHeightFieldGeometry, allow_raw_pointers())
  ...
  register_vector<PxU8>("PxU8Vector");
  ...
  enum_<PxGeometryType::Enum>("PxGeometryType")
      ...
      .value("eGEOMETRY_COUNT", PxGeometryType::Enum::eGEOMETRY_COUNT)
      .value("eINVALID", PxGeometryType::Enum::eINVALID);

  /** Geometry **/
  class_<PxGeometryHolder>("PxGeometryHolder")
      .constructor<>()
      .function("getType", &PxGeometryHolder::getType);
      // .function("sphere", &PxGeometryHolder::sphere)
      // .function("plane", &PxGeometryHolder::plane)
      // .function("capsule", &PxGeometryHolder::capsule)
      // .function("box", &PxGeometryHolder::box)
      // .function("convexMesh", &PxGeometryHolder::convexMesh)
      // .function("triangleMesh", &PxGeometryHolder::triangleMesh)
      // .function("heightField", &PxGeometryHolder::heightField);
  ...
  class_<PxTriangleMesh>("PxTriangleMesh")
      ...
      .function("getVertices", optional_override([](PxTriangleMesh &mesh) {
              std::vector<PxF32> points;
              const PxU32 count = mesh.getNbVertices();
              const PxVec3* vec3 = mesh.getVertices();
              int len = count;
              for (int i = 0; i < len; i++)
              {
                points.push_back(vec3[i].x);
                points.push_back(vec3[i].y);
                points.push_back(vec3[i].z);
              }
              return points;
            }), allow_raw_pointers())
      .function("getTriangles", optional_override([](PxTriangleMesh &mesh) {
		          const void* indexBuffer = mesh.getTriangles();
			        const PxU16* intIndices = static_cast<const PxU16 *>(indexBuffer);
              const PxU32 count = mesh.getNbTriangles();
              std::vector<PxU16> points;
              int len = count * 3;
              for (int i = 0; i < len; i++)
              {
                points.push_back(intIndices[i]);
              }
              return points;
            }), allow_raw_pointers());
  ...
  class_<PxTriangleMeshGeometry, base<PxGeometry>>("PxTriangleMeshGeometry")
      ...
      .function("getScale", optional_override([](PxTriangleMeshGeometry &geo) {
                  return geo.scale;
                }), allow_raw_pointers())
      .function("getMeshFlags", optional_override([](PxTriangleMeshGeometry &geo) {
                  return geo.meshFlags;
                }), allow_raw_pointers())
      .function("getTriangleMesh", optional_override([](PxTriangleMeshGeometry &geo) {
                  return geo.triangleMesh;
                }), allow_raw_pointers())
  ...
  class_<PxConvexMesh>("PxConvexMesh")
      ...
      .function("getVertices", optional_override([](PxConvexMesh &mesh) {
              std::vector<PxF32> points;
              const PxU32 count = mesh.getNbVertices();
              const PxVec3* vec3 = mesh.getVertices();
              int len = count;
      ...
      .function("getIndexBuffer", optional_override([](PxConvexMesh &mesh) {
		          const void* indexBuffer = mesh.getIndexBuffer();
			        const PxU8* intIndices = static_cast<const PxU8 *>(indexBuffer);
              const PxU32 count = mesh.getNbPolygons();
              std::vector<PxU8> points;
              int len = count * 3;
              for (int i = 0; i < len; i++)
              {
                points.push_back(intIndices[i]);
      ...
      // .function("getVertices", &PxConvexMesh::getVertices, allow_raw_pointers())
      // .function("getIndexBuffer", &PxConvexMesh::getIndexBuffer, allow_raw_pointers());
  ...
  class_<PxConvexMeshGeometry, base<PxGeometry>>("PxConvexMeshGeometry")
      ...
      .function("getScale", optional_override([](PxConvexMeshGeometry &geo) {
                  return geo.scale;
                }), allow_raw_pointers())
      .function("getMeshFlags", optional_override([](PxConvexMeshGeometry &geo) {
                  return geo.meshFlags;
                }), allow_raw_pointers())
      .function("getConvexMesh", optional_override([](PxConvexMeshGeometry &geo) {
                  return geo.convexMesh;
                }), allow_raw_pointers())
